...
/**@brief Increments a counter until a stop is demanded, the incrementation is secure
 * by a mutex
 * 
 * @param nLoops: number of times the counter can be incremented
 * @param pCounter: pointer to the counter to be incremented
 * @param pStop: condition that defines whether the incrementing should 
 * continue or not
 * @param mutexLock: bool pointer that defines whether the mutex is locked
 * @param mtx mutex: pointer to mutex that defines which thread has acces to the data
 * @return Returns number of times the counter was incremented
 */
